...
> ### 구매자
 ...
 - [메인페이지] 메인화면 또는 카테고리에서 프로젝트 선택 후 프로젝트 상세페이지 이동
 - [프로젝트 상세페이지] 리워드 또는 후원하기 선택 후 주문
 - [주문서 작성] 전화번호 데이터 없을 경우 문자 인증 후 등록
 -               우편번호 API 이용하여 주소 등록 
 - [결제] 결제 API 이용하여 결제 진행
 - [마이페이지] 회원정보 수정·탈퇴 , 펀딩프로젝트 조회, 관심프로젝트 조회, 1:1 문의글 및 내 댓글 조회
### 　　
> ### 판매자
 - [프로젝트] 판매자 공지사항 작성
 - [마이페이지] 구매자와 동일, 나의 프로젝트 조회
### 　　
> ### 관리자
 - 본인 기능 상세적기
 - 본인 기능 상세적기
